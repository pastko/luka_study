...
class GraphWithAdjacencyList {
    ...
    removeVertex(vertex) {
        ...
        if (this.contains(vertex)) {
            ...
            // {
            //     this.removeEdge(this.vertices[vertex][i], vertex);
            // }
...
// console.table(adjList.contains("Seoul"));
console.table(adjList.hasEdge("Seoul", "Daejeon"));
console.table(adjList.hasEdge("Daejeon", "Seoul"));


adjList.removeVertex("Seoul");
console.log(adjList.hasEdge("Daejeon", "Seoul"));
console.log(adjList.hasEdge("Busan", "Seoul"));
console.dir(adjList)